...
from .views import DrinkOrderViewSet, TournamentViewSet, ScoreViewSet, DrinkViewSet, create_auth, UserViewSet, createDrinkOrder, CurrentUserRetrieve, updateBalance, updateRole
